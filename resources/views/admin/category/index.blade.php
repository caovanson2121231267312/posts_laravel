                                    ...
                                    <tbody>
                                        @foreach($data as $value)
                                            <tr>
                                                ...
                                                <th>
                                                    <div>
                                                        <a class="btn btn-success" href="{{route("categories.show",['id'=>$value->id])}}" data-tippy-content="{{ __('messages.detail') }}">
                                                            <i class="fas fa-eye"></i>
                                                        </a>
                                                        <a class="btn btn-warning" href="{{route("categories.edit",['id'=>$value->id])}}" data-tippy-content="{{ __('messages.edit') }}">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <a class="btn btn-danger" href="{{route("categories.delete",['id'=>$value->id])}}"  data-tippy-content="{{ __('messages.delete') }}">
                                                            <i class="fas fa-trash-alt"></i>
                                                        </a>
                                                    </div>
                                                </th>
